...
export function HelpGuidance() {
  ...
  const steps: Step[] = [
    ...
    {
      title: '1. Siapkan Dompet Pertama',
    ...
    {
      title: '6. Evaluasi Lewat Laporan',
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-mono font-medium uppercase tracking-wider text-neutral-450 dark:text-neutral-500">

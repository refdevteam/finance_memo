  ...
  return (
    <div className="grid grid-cols-2 gap-2.5 md:hidden">
      ...
      <Dialog open={activeDialog === 'budget'} onOpenChange={(open) => setActiveDialog(open ? 'budget' : null)}>
        <DialogTrigger render={
          <Card className="cursor-pointer active:scale-98 transition-transform select-none hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_rgba(0,0,0,1)] dark:hover:shadow-[1px_1px_0px_rgba(255,255,255,0.15)] min-h-[92px] flex flex-col justify-between p-3 border-2 border-black dark:border-white bg-white dark:bg-zinc-900 text-black dark:text-white shadow-[3px_3px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_rgba(255,255,255,0.15)] rounded-2xl">
            <div>
              ...
              {totalBudgeted > 0 ? (
                <p className="text-[12px] font-black font-mono mt-1 truncate">
        ...
        <DialogContent className="max-w-[95%] rounded-2xl p-5 bg-white dark:bg-zinc-900 border-2 border-black dark:border-white shadow-[8px_8px_0px_rgba(0,0,0,1)]">
          <DialogHeader>
          ...
          <Card className="cursor-pointer active:scale-98 transition-transform select-none hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_rgba(0,0,0,1)] dark:hover:shadow-[1px_1px_0px_rgba(255,255,255,0.15)] min-h-[92px] flex flex-col justify-between p-3 border-2 border-black dark:border-white bg-white dark:bg-zinc-900 text-black dark:text-white shadow-[3px_3px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_rgba(255,255,255,0.15)] rounded-2xl">
            ...
            <div className="mt-2">
              {upcomingRemindersCount > 0 ? (
                <div className="flex items-center justify-center gap-1.5 bg-rose-50 dark:bg-rose-950/20 text-rose-600 dark:text-rose-400 py-1 px-2 rounded-lg border border-black dark:border-white text-[10px] font-black">
                ...
                <div className="flex items-center justify-center gap-1.5 bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 py-1 px-2 rounded-lg border border-black dark:border-white text-[10px] font-black">
